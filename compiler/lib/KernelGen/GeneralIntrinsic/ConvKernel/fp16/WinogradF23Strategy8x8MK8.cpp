/**
 * \file
 * compiler/lib/KernelGen/GeneralIntrinsic/ConvKernel/fp16/WinogradF23Strategy8x8MK8.cpp
 *
...
#include "WinogradF23Strategy8x8MK8.h"
#include <string>
...
std::string WinogradF23Strategy8x8MK8::BatchedMatMul(
        const std::vector<std::string>& strs) {
