/**
 * \file
 * compiler/lib/KernelGen/GeneralIntrinsic/MatMulKernel/Fp32Gemv.cpp
 *
...
#define CUMULATE(i) \
acc[i] += GiGetLaneFloat32(GiGetLowFloat32(sum##i),0);\
acc[i] += GiGetLaneFloat32(GiGetLowFloat32(sum##i),1);\
acc[i] += GiGetLaneFloat32(GiGetHighFloat32(sum##i),0);\
acc[i] += GiGetLaneFloat32(GiGetHighFloat32(sum##i),1);
