/**
 * \file
 * compiler/lib/KernelGen/Arm/Arm64/MatMulKernel/Fp32MatMulM8N12.cpp
 *
...
bool Fp32MatMulM8N12::IsAvailable(TContext* context) const {
...
//! kernel gen
std::string Fp32MatMulM8N12::GetKernelSymbol(TContext* context) const {
    std::stringstream ss;
    ss << "Arm64_kernel_fp32_matmul_8x12_";
...
std::string Fp32MatMulM8N12::GetWorkspaceBody(TContext* context) const {
    std::stringstream ss;
...
std::string Fp32MatMulM8N12::GetKernelBody(TContext* context) const {
    ...
    auto gemm_kernel = MatmulM8N12Kernel();
...
std::vector<KernelObj> Fp32MatMulM8N12::GetDependInternalSymbol(
