/**
 * \file
 * compiler/lib/KernelGen/Arm/Arm64/ConvKernel/Fp32/Fp32Im2col.cpp
 *
...
std::string ConvIm2colFloat::GetKernelSymbol(TContext* ctx) const {
    ...
    std::string name_temp =
            "Arm64_kernel_conv2d_im2col_${kernel_h}x${kernel_w}_${"
...
MatmulInternal* ConvIm2colFloat::GetInnerCtxMatmul(TContext* ctx) const {
    static MatmulM8N12MK4Kernel inner_mk4_gemm;
