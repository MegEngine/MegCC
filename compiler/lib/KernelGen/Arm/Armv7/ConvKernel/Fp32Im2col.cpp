/**
 * \file
 * compiler/lib/KernelGen/Arm/Armv7/ConvKernel/Fp32Im2col.cpp
 *
...
std::string ConvIm2colFloat::GetKernelSymbol(TContext* ctx) const {
    ...
    std::string name_temp =
            "Armv7_kernel_conv2d_im2col_${kernel_h}x${kernel_w}_${"
...
ArmCommon::MatmulInternal* ConvIm2colFloat::GetInnerCtxMatmul(TContext* ctx) const {
