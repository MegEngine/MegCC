...
INSTANCE_GET_KERNELS(
        mlir::Kernel::IndexingMultiAxisVecKernel, KernType::IndexingMultiAxisKernel)
INSTANCE_GET_KERNELS(mlir::Kernel::ReduceKernel, KernType::ReduceKernel)
INSTANCE_GET_KERNELS(mlir::Kernel::BatchedMatrixMulKernel, KernType::BatchMatmulKernel)
...
INSTANCE_GET_KERNELS(
        mlir::Kernel::WarpPerspectiveKernel, KernType::WarpPerspectiveKernel)
...
INSTANCE_GET_KERNELS(mlir::Kernel::ElemwiseKernelInterface, KernType::ElemwiseKernel)
INSTANCE_GET_KERNELS(mlir::Kernel::ElemwiseMultiType, KernType::ElemwiseMultiKernel)
...
void addBuiltinTemplatesOpr(
        mlir::Kernel::KernelTemplateRegistry& registry, megcc::KernelGen::Arch arch,
        Args&&... args) {
...
void addBuiltinTemplatesByOperator(
    ...
    addBuiltinTemplatesOpr<mlir::Kernel::ElemwiseKernelInterface>(
            ...
            [&](mlir::Operation* op, megcc::TContext* ctx) {
                auto elem = llvm::dyn_cast<mlir::Kernel::ElemwiseKernelInterface>(op);
    ...
    addBuiltinTemplatesOpr<mlir::Kernel::BatchedMatrixMulKernel>(registry, arch);
    ...
    addBuiltinTemplatesOpr<mlir::Kernel::IndexingMultiAxisVecKernel>(registry, arch);
