/**
 * \file
 * compiler/test/kernel/opr/generalIntrinsic/benchmark_relayout.cpp
 *
...
TEST(GI, BENCHMARK_Relayout) {
    Benchmarker<RelayoutForward> benchmarker(Arch::BAREMETAL);
    benchmarker.set_kernel_symbol("GI_kernel_relayout_.*");
