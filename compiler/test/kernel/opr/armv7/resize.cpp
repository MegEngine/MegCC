/**
 * \file
 * compiler/test/kernel/opr/armv7/resize.cpp
 *
...
TEST(ARMV7, Resize) {
    Checker<ResizeForward> checker(Arch::ARMV7);
...
TEST(ARMV7, BENCHMARK_Resize) {
    Benchmarker<ResizeForward> benchmarker(Arch::ARMV7);
    megdnn::ResizeForward::Param param;
    param.format = megdnn::ResizeForward::Param::Format::NCHW;
    param.imode = megdnn::ResizeForward::Param::InterpolationMode::LINEAR;
