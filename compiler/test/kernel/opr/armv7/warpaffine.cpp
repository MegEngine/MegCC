/**
 * \file
 * compiler/test/kernel/opr/armv7/warpaffine.cpp
 *
...
TEST(ARMV7, WarpAffine) {
    Checker<WarpAffineForward> checker(Arch::ARMV7);
    NormalRNG rng;
...
TEST(ARMV7, BenchmarkWarpAffine) {
    Benchmarker<WarpAffineForward> benchmarker(Arch::ARMV7);
    WarpAffineForward::Param param;
