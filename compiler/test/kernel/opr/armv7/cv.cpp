...
TEST(ARMV7, CVresize) {
    Checker<megdnn::CVResize> checker(Arch::ARMV7);
...
TEST(ARMV7, CVcvtcolor) {
    Checker<megdnn::CVCvtColor> checker(Arch::ARMV7);
...
TEST(ARMV7, CVWarpAffine) {
    ...
    Checker<CVWarpAffine> checker(Arch::ARMV7);
...
TEST(ARMV7, CVtranspose) {
    Checker<megdnn::CVtranspose> checker(Arch::ARMV7);
    UniformIntRNG n_rng(0, 255);
    checker.set_rng(0, &n_rng);
    checker.set_dtype(0, dtype::Uint8());
    checker.set_dtype(1, dtype::Uint8());
...
TEST(ARMV7, CVflip) {
    Checker<megdnn::CVflip> checker(Arch::ARMV7);
...
TEST(ARMV7, CVrotate) {
    Checker<megdnn::CVRotate> checker(Arch::ARMV7);
