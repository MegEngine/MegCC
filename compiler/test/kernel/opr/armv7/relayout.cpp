/**
 * \file
 * compiler/test/kernel/opr/armv7/relayout.cpp
 *
...
TEST(ARMV7, Relayout) {
    Checker<RelayoutForward> checker(Arch::ARMV7);
...
TEST(ARMV7, RelayoutConcatSubtensor) {
    Checker<RelayoutForward> checker(Arch::ARMV7);
