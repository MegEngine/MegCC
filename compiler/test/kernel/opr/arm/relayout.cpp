/**
 * \file
 * compiler/test/kernel/opr/arm/relayout.cpp
 *
...
TEST(AARCH64, RelayoutConcatSubtensor) {
    Checker<RelayoutForward> checker(Arch::ARM64);
