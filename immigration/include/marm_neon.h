...
__attribute__((target("dotprod"))) __ai int32x4_t vdotq2_s32(int8x16_t a, int8x16_t b) {
    int32x4_t c = vdupq_n_s32(0);
    return vdotq_s32(c, a, b);
}

__attribute__((target("dotprod"))) __ai uint32x4_t
vdotq2_u32(uint8x16_t a, uint8x16_t b) {
...
__attribute__((target("dotprod"))) __ai int32x2_t vdot2_s32(int8x8_t a, int8x8_t b) {
    int32x2_t c = vdup_n_s32(0);
    return vdot_s32(c, a, b);
}

__attribute__((target("dotprod"))) __ai uint32x2_t vdot2_u8(uint8x8_t a, uint8x8_t b) {
...
__ai int8x16_t vqtbl1q_s8(int8x16_t a, uint8x16_t idx) {
    ...
    src.val[1] = src_high;
    return vcombine_s8(
            vtbl2_s8(src, vget_low_s8(vreinterpretq_s8_u8(idx))),
...
__ai float32x4_t vfmaq_laneq_f32_0(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlaq_lane_f32(a, b, vget_low_f32(v), 0);
}
__ai float32x4_t vfmaq_laneq_f32_1(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlaq_lane_f32(a, b, vget_low_f32(v), 1);
}
__ai float32x4_t vfmaq_laneq_f32_2(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlaq_lane_f32(a, b, vget_high_f32(v), 0);
}
__ai float32x4_t vfmaq_laneq_f32_3(float32x4_t a, float32x4_t b, float32x4_t v) {
...
__ai float32x4_t vfmsq_laneq_f32_0(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlsq_lane_f32(a, b, vget_low_f32(v), 0);
}
__ai float32x4_t vfmsq_laneq_f32_1(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlsq_lane_f32(a, b, vget_low_f32(v), 1);
}
__ai float32x4_t vfmsq_laneq_f32_2(float32x4_t a, float32x4_t b, float32x4_t v) {
    return vmlsq_lane_f32(a, b, vget_high_f32(v), 0);
}
__ai float32x4_t vfmsq_laneq_f32_3(float32x4_t a, float32x4_t b, float32x4_t v) {
...
__ai float32x4_t vfmaq_laneq_f32_impl_0(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmla %0.4s, %1.4s, %2.s[0]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmaq_laneq_f32_impl_1(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmla %0.4s, %1.4s, %2.s[1]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmaq_laneq_f32_impl_2(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmla %0.4s, %1.4s, %2.s[2]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmaq_laneq_f32_impl_3(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmla %0.4s, %1.4s, %2.s[3]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmsq_laneq_f32_impl_0(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmls %0.4s, %1.4s, %2.s[0]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmsq_laneq_f32_impl_1(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmls %0.4s, %1.4s, %2.s[1]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmsq_laneq_f32_impl_2(float32x4_t a, float32x4_t b, float32x4_t v) {
    asm volatile("fmls %0.4s, %1.4s, %2.s[2]\n" : "+w"(a) : "w"(b), "w"(v) :);
    return a;
}

__ai float32x4_t vfmsq_laneq_f32_impl_3(float32x4_t a, float32x4_t b, float32x4_t v) {
